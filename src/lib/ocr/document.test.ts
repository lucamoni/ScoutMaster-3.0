...
describe('normalizeDocumentData', () => {
  ...
  it('accepts Italian dates and tax codes with OCR separators', () => {\n    expect(normalizeDocumentData({ data_nascita: '03/02/2010', codice_fiscale: 'RSSMRA 10A01H501U' })).toMatchObject({ data_nascita: '2010-02-03', codice_fiscale: 'RSSMRA10A01H501U' })\n  })\n\n  it('rejects malformed dates, tax codes and phones', () => {
